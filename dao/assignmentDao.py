...
class AssignmentDao:
    ...
    def create(cls, Assignment: Assignment):
        ...
        MySql.query(
            ...
            VALUES ('{Assignment.id_commessa}', IF('{Assignment.descrizione}' = 'None', NULL, '{Assignment.descrizione}'), '{Assignment.id_cliente}', '{Assignment.id_azienda}', '{Assignment.data_inizio}', '{Assignment.data_fine}')"
        )
    ...
    def update_by_id(cls, id: str , Assignment: Assignment):
        MySql.open_connection()
        MySql.query(
            f"UPDATE commessa SET descrizione = IF('{Assignment.descrizione}' = 'None', NULL, '{Assignment.descrizione}'), id_cliente = '{Assignment.id_cliente}', id_azienda = '{Assignment.id_azienda}', data_inizio = '{Assignment.data_inizio}', data_fine = '{Assignment.data_fine}' \
